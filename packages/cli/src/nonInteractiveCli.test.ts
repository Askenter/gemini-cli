...
import { Config, GeminiClient, ToolRegistry } from '@google/torch-pilot-core';
import { GenerateContentResponse, Part, FunctionCall } from '@google/genai';

// Mock dependencies
vi.mock('@google/torch-pilot-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@google/torch-pilot-core')
  >('@google/torch-pilot-core');
  return {
    ...actualCore,
    GeminiClient: vi.fn(),
    ToolRegistry: vi.fn(),
